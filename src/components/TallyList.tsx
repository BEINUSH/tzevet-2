      ...
      {tally.map((t, i) => {
        ...
        return (
          <motion.div
            ...
            className="grid grid-cols-[minmax(12rem,18rem)_minmax(10rem,1fr)_7rem] items-center gap-4"
          >
            <div
              className={clsx(
                "min-w-0 whitespace-normal break-words text-right font-semibold leading-tight",
                textSize,
            ...
            <div className={clsx("w-full rounded-full bg-brand-navy-lighter overflow-hidden", barHeight)}>
              <motion.div
                className={clsx(
                  "h-full rounded-full",
            ...
            <div className={clsx("text-left font-bold tabular-nums", textSize)}>
